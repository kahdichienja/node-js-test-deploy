...
* `k8s/` - Contains all Kubernetes declarative manifests (Namespace, Deployment, Service, Ingress) ☸️
...
- Build the Docker image locally 🏗️
- Push it directly to your Docker registry using `push.sh` ☁️
...
⚠️ **Important**: Navigate to your GitHub repository **Settings -> Secrets and variables -> Actions** and add the following repository secrets:
* `DOCKER_USERNAME`
* `DOCKER_TOKEN`
